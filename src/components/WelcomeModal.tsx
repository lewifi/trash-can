...
import { Star, Compass, X } from "lucide-react";
 ...
 * dangle the mystery — an obscured clue — so the curious have a reason to stick
 * around and dig. Deliberately cryptic: no visual of the buried world here (that
 * glimpse is saved for deep in the hunt); this just hints the hidden hunt exists.
 */
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md rounded-2xl border border-cyan-500/30 bg-[#0b0f19] p-6 shadow-2xl neon-glow-cyan depth-top overflow-hidden">
        ...
        {/* Mystery hook: no visual of the world here (that glimpse is saved for deep in
            the hunt) — just an obscured clue to hint that something is buried. */}
